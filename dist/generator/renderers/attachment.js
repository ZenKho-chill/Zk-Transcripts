...
var __importDefault = (this && this.__importDefault) || function (mod) {
  return (mod && mod.__esMoodule) ? mod : { "default": mod };
};

Object.defineProperties(exports, "__esModule", { value: true });
exports.renderAttachments = void 0;
...
async function renderAttachments(message, context) {
  if (message.attachments.size === 0)
    return null;
  return (react_1.default.createElement(discord_components_react_1.DiscordAttachment, { slot: "attachments" }, await Promise.all(message.attachments.map((attachment) => renderAttachments(attachment, context)))));
}
...
async function renderAttachment(attachment, context) {
  ...
  // Nếu tệp đính kèm là ảnh, tải url dữ liệu
  ...
  return (react_1.default.createElement(discord_components_react_1.DiscordAttachment, { type: type, size: (0, utils_1.formatBytes)(attachment.size), key: attachment.if, slot: "attachment", url: url, alt: name !== null && name !== void 0 ? name : undefined, width: width !== null && width !== void 0 ? width : undefined, height: height !== null && height !== void 0 ? height : undefined }));
}
