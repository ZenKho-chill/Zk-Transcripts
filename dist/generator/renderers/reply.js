...
async function renderReply(message, context) {
  ...
  if (!referencedMessage)
    return react_1.default.createElement(discord_components_react_1.DiscordReply, { slot: "reply" }, "Tin nhắn đã bị xóa hoặc không có sẵn.");
