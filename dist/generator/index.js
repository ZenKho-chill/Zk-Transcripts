...
// Đọc package.json và lấy thông tin phiên bản cho @derockdev/discord-components-core
...
try {
  ...
  // Bỏ qua lỗi nếu không thể đọc package.json
}
...
async function renderMessages(_a) {
  ...
  for (const message of messages) {
    const rendered = await (0, message_1.default)(message, Object.assign({
      messages,
      channel,
      callbacks
    }, options));
  ...
  const elements = (react_1.default.createElement(discord_components_react_1.DiscordMessages, { style: { minHeight: '100vh' } },
    react_1.default.createElement(discord_components_react_1.DiscordHeader, {
      guild: channel.isDMBased() ? 'Tin nhắn trực tiếp' : channel.guild.name, channel: channel.isDMBased()
        ? channel.type === discord_js_1.ChannelType.DM
          ? (_c = (_b = channel.recipient) === null || _b === void 0 ? void 0 : _b.tag) !== null && _c !== void 0 ? _c : 'Không rõ người nhận'
          : 'Không rõ người nhận'
        : channel.name, icon: channel.isDMBased() ? undefined : (_d = channel.guild.iconURL({ size: 128 })) !== null && _d !== void 0 ? _d : undefined
    }, channel.isThread()
      ? `Kênh chủ đề trong ${(_f = (_e = channel.parent) === null || _e === void 0 ? void 0 : _e.name) !== null && _f !== void 0 ? _f : 'Không rõ kênh'}`
      : channel.isDMBased()
        ? `Tin nhắn trực tiếp`
        : channel.isVoiceBased()
          ? `Kênh thoại cho ${channel.name}`
          : channel.type === discord_js_1.ChannelType.GuildCategory
            ? `Kênh danh mục`
            : 'topic' in channel && channel.topic
              ? await (0, content_1.default)(channel.topic, Object.assign({
                messages,
                channel,
                callbacks, type: content_1.RenderType.REPLY
              }, options))
              : `Đây là khởi đầu của kênh #${channel.name}.`),
    chatBody,
    react_1.default.createElement("div", { style: { textAlign: 'center', width: '100%' } },
      options.footerText
        ? options.footerText
          .replaceAll('{number}', messages.length.toString())
        : `Đã xuất ra ${messages.length} tin nhắn.`,
      ' ',
      options.poweredBy ? (react_1.default.createElement("span", { style: { textAlign: 'center' } },
        "Được tạo bởi",
        ' ',
        react_1.default.createElement("a", { href: "https://zenkho.top", style: { color: 'lightblue' } }, "zk-transcript"),
        ".")) : null)));
  ...
  const markup = server_1.default.renderToStaticMarkup(react_1.default.createElement("html", null,
    react_1.default.createElement("head", null,
      ...
      react_1.default.createElement("link", {
        rel: "icon", type: "image/png", href: options.favicon === 'guild'
          ? channel.isDMBased()
            ? undefined
            : (_g = channel.guild.iconURL({ size: 16, extension: 'png' })) !== null && _g !== void 0 ? _g : undefined
          : options.favicon
      }),
      react_1.default.createElement("title", null, channel.isDMBased() ? 'Tin nhắn trực tiếp' : channel.name),
